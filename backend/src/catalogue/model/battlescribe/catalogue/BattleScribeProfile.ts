...
export class BattleScribeProfile extends BattleScribeEntity {
    ...
    static fromXMLNode(xmlDocument: XML): BattleScribeProfile {
        return new BattleScribeProfile(
            ...
            getOptionalArray("modifierGroups",xmlDocument,BattleScribeModifierGroup.fromXMLNode),
            getOptionalArray("characteristics",xmlDocument,BattleScribeCharacteristic.fromXMLNode)
        )
    } 
}