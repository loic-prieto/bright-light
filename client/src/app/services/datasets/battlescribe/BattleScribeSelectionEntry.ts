...
export class BattleScribeSelectionEntry extends BattleScribeEntity {
    ...
    static fromXMLNode(xmlDocument: XML): BattleScribeSelectionEntry {
        return new BattleScribeSelectionEntry(
            ...
            getOptionalArray("modifiers",xmlDocument,BattleScribeModifier.fromXMLNode),
            getOptionalArray("constraints",xmlDocument,BattleScribeConstraint.fromXMLNode),
            getOptionalArray("profiles",xmlDocument,BattleScribeProfile.fromXMLNode),
            getOptionalArray("infoLinks",xmlDocument,BattleScribeInfoLink.fromXMLNode),
            getOptionalArray("categoryLinks",xmlDocument,BattleScribeCategoryLink.fromXMLNode),
            getOptionalArray("selectionEntryGroups",xmlDocument,BattleScribeSelectionEntryGroup.fromXMLNode),
            getOptionalArray("entryLinks",xmlDocument,BattleScribeEntryLink.fromXMLNode),
